    ...
    <div>
      ...
      <div class="page-container">
        ...
        <div class="page-container3">
          ...
          <form class="sign-in3-form1" name="boardForm" action="updatePro.jsp" method="post" onsubmit="return validateForm()">
            ...
            <div data-thq="thq-navbar-nav" class="navbar12-desktop-menu">
              <div class="navbar12-buttons">
                ...
                >
                  ...
                  <button type="button" onclick="location.href='content.jsp'">취소</button>
                </a>
                </form>
              </div>
            </div>

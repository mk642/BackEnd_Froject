        ...
        <div class="page3-navbar">
          ...
          <div class="page3-middle">
            <div class="page3-left">
              <span class="page3-text navbar-link" OnClick="location.href='warring.jsp'">
                <span>그래픽카드</span>
                <br />
              </span>
              <span class="page3-text03 navbar-link" OnClick="location.href='warring.jsp'"> 
                <span>CPU</span>
                <br />
              </span>
              <span class="page3-text06 navbar-link" OnClick="location.href='warring.jsp'">메인보드</span>
            </div>
            <input
              type="text"
              placeholder="search"

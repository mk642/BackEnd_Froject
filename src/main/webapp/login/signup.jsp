        ...
        <div class="page2-navbar">
          ...
          <div class="page2-middle">
            <div class="page2-left">
              <span class="page2-text navbar-link" OnClick="location.href='warring.jsp'">
                <span>그래픽카드</span>
                <br />
              </span>
              <span class="page2-text03 navbar-link" OnClick="location.href='warring.jsp'">
                <span>CPU</span>
                <br />
              </span>
              <span class="page2-text06 navbar-link" OnClick="location.href='warring.jsp'">메인보드</span>
            </div>
            <input
              type="text"
              placeholder="search"
            ...
            <div class="page2-right">
              <img
                ...
                class="page2-image"
              />
              <span class="navbar-link" OnClick="location.href='warring.jsp'">RAM</span>
              <span class="navbar-link" OnClick="location.href='warring.jsp'">HDD/SSD</span>
              <span class="navbar-link" OnClick="location.href='warring.jsp'">케이스</span>
            </div>
          </div>

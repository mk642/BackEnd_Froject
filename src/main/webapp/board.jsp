        ...
        <div class="page1-navbar">
          <header data-role="Header" class="page1-header ">
            <div class="page1-container1">
              ...
              <div>
                <a href="main.jsp" class="page1-logo-center navbar-logo-title">
                  PartsSale
                </a>
                <div class="page1-middle">
                  ...
                  <img
                    ...
                    class="page1-image2"
                  />
                  <a href="logout.jsp" class="page1-navlink1">
                    <img
            ...
            <div class="faq1-max-width thq-section-max-width">
             ...
             <div class="container">
				...
				<table class="table table-hover">
					...
					<tr>
						<td><%=dto.getNo() %></td>
						<td><a href="updateForm.jsp?id=<%=dto.getTitle()%>"><%=dto.getTitle()%></a></td>
						<td><%=dto.getName()%></td>
						<td><%=dto.getView()%></td>
						<td><%=dto.getDate()%></td>
					</tr>
